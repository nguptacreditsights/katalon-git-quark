...
WebUI.setText(findTestObject('Object Repository/PublishSFA/Page_Quark Publishing Platform Web Client/input_Title_articleTitle'), 
    'Title: ShortFormArticle1')

WebUI.setText(findTestObject('PublishSFA/Page_Quark Publishing Platform Web Client/input_FileName_articleTitle'), 'Title: ShortFormArticle1')
...
WebUI.switchToWindowTitle('Title: ShortFormArticle1.xml')
...
WebUI.doubleClick(findTestObject('Object Repository/PublishSFA/Page_ShortFormArticle1xml/li_Asia Summary (1)'))

//WebUI.click(findTestObject('Object Repository/PublishSFA/Page_ShortFormArticle1xml/li_Subscriber Highlights (1)'))
WebUI.doubleClick(findTestObject('Object Repository/PublishSFA/Page_ShortFormArticle1xml/li_Subscriber Highlights (1)'))
...
WebUI.navigateToUrl('https://www-b.staging.creditsights.com/login')
